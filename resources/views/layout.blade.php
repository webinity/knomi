...
<body>
    ...
    <header class="bg-transparent fixed lg:absolute w-full z-50 overflow-y-auto h-[60px] lg:h-min top-0 lg:overflow-y-visible">
        ...
        <div class="container max-w-[1256px] px-6 mx-auto flex justify-between items-center">
            <!-- Logo na levé straně -->
                    ...
                    <div id="about-dropdown" class="absolute left-0 bg-primary-black shadow-md w-48 hidden opacity-0 scale-95 transition-all duration-300">
                        <ul>
                            <li class="border-b-[1px] border-primary-blue hover:bg-[rgba(50,56,62,0.6)]">
                                <a href="#nase-firma" class="block px-4 py-2 text-[18px] text-white">Naše firma</a>
                            </li>
                            <li class="border-b-[1px] border-primary-blue hover:bg-[rgba(50,56,62,0.6)]">
                    ...
                    <nav class="space-y-6">
                        ...
                        <div class="relative">
                            ...
                            <div id="mobile-about-menu" class="hidden mt-4 ml-4 space-y-4">
                                <a href="#nase-firma" class="block text-white text-[20px]">Naše firma</a>
                                <a href="#galerie" class="block text-white text-[20px]">Galerie</a>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            ...
                            <div id="mobile-products-menu" class="hidden mt-4 ml-4 space-y-4 product-nav">
                                <a href="#soustruzne-dily" class="block text-white text-[20px]">Soustružné díly</a>
                                <a href="#tvarene-trubky" class="block text-white text-[20px]">Tvářené trubky</a>
                                <a href="#hydraulicka-sroubeni" class="block text-white text-[20px]">Hydraulická šroubení</a>
                                <a href="#pneumatika" class="block text-white text-[20px]">Pneumatika</a>
                            </div>
                        </div>

                        <!-- Ostatní odkazy -->
                        <a href="#ke-stazeni" class="block text-white text-[24px]">Ke stažení</a>
                        <a href="/kariera" class="block text-white text-[24px]">Kariéra</a>
                        <a href="#kontakt" class="block text-white text-[24px]">Kontakt</a>
                        ...
                        <div class="pt-4">
                            <div class="flex justify-center space-x-4">
                                <button onclick="selectMobileLanguage('CZ')" class="text-white text-[20px] px-4 py-2">CZ</button>
                                <button onclick="selectMobileLanguage('EN')" class="text-white text-[20px] px-4 py-2">EN</button>
                            </div>
                        </div>
                    </nav>
                </div>
    ...
    <div class="w-full h-[50px] md:h-[90px] bg-primary-black flex items-center justify-center">
        <span class="text-white text-[18px] lg:text-[24px]">© 2024</span>
    </div>
