...
<head>
    ...
    <link rel="icon" href="/knomi_64x64.png" type="image/png">
...
<body>
    ...
    <header class="bg-transparent fixed lg:absolute w-full z-50 overflow-y-auto h-[60px] lg:h-min top-0 lg:overflow-y-visible">
        <div class="h-[90px] bg-primary-black border-white hidden lg:block">
            <div class="container max-w-[1256px] mx-auto flex justify-end items-center px-6 space-x-4 h-full">
                {{-- TODO: prekontrolovat, jeslti funguje, az bude nasazena https verze --}}
                <!-- Tlačítko 1 -->
                <a href="http://shop.knomi.cz/" target="_blank" class="bg-[#D7DCEB] lg:text-[24px] text-[18px] text-primary-black py-[8px] px-[16px] lg:py-[12px] lg:px-[24px] flex items-center justify-center rounded-btn border-2 border-transparent hover:border-primary-blue hover:ring-2 hover:ring-primary-blue focus:outline-none transition-all duration-300 ease-in-out leading-[1.25] font-semibold">
                    {{ __('header.catalog') }}
                </a>
                ...
                {{-- TODO: az budou preklady, odstrnait hidden --}}
    ...
    <footer class="bg-cover bg-center bg-no-repeat text-primary-black py-[40px] md:py-[60px] lg:py-[90px]"  style="background-image: url('{{url('/images/bg_hero.webp')}}')">
