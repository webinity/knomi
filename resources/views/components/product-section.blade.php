        ...
        <div class="relative">
            <div class="container max-w-[1256px] mx-auto px-6 flex flex-col lg:block">
                <div class="lg:w-[calc(50%-45px)] lg:p-[40px] p-[20px] lg:order-none order-2 text-white text-[18px] lg:text-[24px] font-bold bg-no-repeat bg-center bg-cover product-content" style="background-image: url('{{ $bg }}')">
                    ...
                    <a href="#kontakt" class="lg:text-[24px] text-[18px] text-black font-semibold lg:py-[12px] py-[8px] lg:px-[30px] px-[15px] bg-primary-yellow text-primary-black lg:mt-[40px] mt-[20px] mx-auto block w-fit hover:bg-primary-blue hover:text-white transition-colors duration-200">{{ __('homepage.cta.button') }}</a>
                </div>
