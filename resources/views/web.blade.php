...
<section>
    ...
    <x-product-section id="soustruzne-dily" bg="{{url('/images/bg_soustruzne_dily.webp')}}" title="{{ __('homepage.products.turned_parts') }}" content="homepage.turned_parts.content" :gallery="['soustruzeni_1.webp', 'soustruzeni_2.webp', 'soustruzeni_3.webp', 'soustruzeni_4.webp', 'soustruzeni_5.webp', 'soustruzeni_6.webp', 'soustruzeni_7.webp', 'soustruzeni_7.webp', 'soustruzeni_7.webp']" class="product-section" />

    <x-product-section id="tvarene-trubky" bg="{{url('/images/bg_tvarene_trubky.webp')}}" title="{{ __('homepage.products.formed_tubes') }}" content="homepage.formed_pipes.content" :gallery="['trubky_1.webp', 'trubky_2.webp', 'trubky_3.webp', 'trubky_4.webp', 'trubky_5.webp', 'trubky_6.webp', 'trubky_7.webp','trubky_8.webp']" class="hidden product-section" />

    <x-product-section id="hydraulicka-sroubeni" bg="{{url('/images/bg_hydraulicka_sroubeni.webp')}}" title="{{ __('homepage.products.hydraulic_fittings') }}" content="homepage.hydraulic_fittings.content" :gallery="['hydraulika_1.webp', 'hydraulika_2.webp', 'hydraulika_3.webp', 'hydraulika_4.webp', 'hydraulika_5.webp', 'hydraulika_6.webp', 'hydraulika_7.webp', 'hydraulika_8.webp', 'hydraulika_9.webp', 'hydraulika_10.webp', 'hydraulika_11.webp', 'hydraulika_12.webp', 'hydraulika_13.webp']" class="hidden product-section" />

    <x-product-section id="pneumatika" bg="{{url('/images/bg_pneumatika.webp')}}" title="{{ __('homepage.products.pneumatics') }}" content="homepage.tire.content" :gallery="['pneumatika_1.webp', 'pneumatika_2.webp', 'pneumatika_3.webp', 'pneumatika_4.webp', 'pneumatika_5.webp']" class="hidden product-section" />
</section>
...
<section id="galerie" class="py-[40px] md:py-[60px] lg:py-[90px]">
    <div class="container max-w-[1256px] mx-auto px-6">
        ...
        <figure class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[10px] md:gap-[20px] lg:gap-[50px]">
            ...
            <a data-fslightbox="gallery" href="{{url('/images/gallery_4.webp')}}" class="w-full h-[275px] bg-primary-grey border-2 border-primary-black lg:border-4 hover:border-primary-blue transition-colors duration-200">
                <img src="{{url('/images/gallery_4.webp')}}" alt="Galerie" class="w-full h-full object-cover">
            </a>

            <a data-fslightbox="gallery" href="{{url('/images/gallery_5.webp')}}" class="w-full h-[275px] bg-primary-grey border-2 border-primary-black lg:border-4 hover:border-primary-blue transition-colors duration-200">
                <img src="{{url('/images/gallery_5.webp')}}" alt="Galerie" class="w-full h-full object-cover">
            </a>
        ...
        <div class="flex flex-col lg:flex-row gap-[40px]">
            <div class="lg:w-[50%]">
                <div class="mb-[20px] lg:mb-[30px]">
                    ...
                    <p class="mb-4 lg:text-[18px] text-[16px] text-primary-black font-bold">{{ __('homepage.contact.people.name') }}, {{ __('homepage.contact.people.position') }}
                        <span class="block">+420 737 482 117</span>
                    </p>
                    ...
                    <p class="lg:text-[18px] text-[16px] text-primary-black font-bold">{{ __('homepage.contact.people.name') }}, {{ __('homepage.contact.people.position') }}
                        <span class="block">+420 483 397 146</span>
                    </p>
                </div>
